...
describe('Noum.Connect.spec.tsx', () => {
  before(() => {
  ...
  it('decline user connection request', () => {
    ...
    NotificationPage.viewNotificationContentOnList(
      `${Cypress.env('AUTO_USER_TWO_NAME')} wants to connect to ${noumName}.`,
    );

    NoumManage.viewRequestInviteModal().declineNoumInvite(
  ...
  it('accept user connection request', () => {
    ...
    NoumManage.viewRequestInviteModal().acceptNoumInvite(
      Cypress.env('AUTO_USER_TWO_NAME'),
    );
  });
