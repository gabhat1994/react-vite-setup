...
describe.skip('User.Connect.Home.spec.tsx', () => {
  before(() => {
  ...
  it('decline user connection request', () => {
    ...
    NoumManage.verifyNoumReceivedRequest(
      Cypress.env('AUTO_USER_TWO_NAME')
    ).declineNoumInvite(Cypress.env('AUTO_USER_TWO_NAME'));
  });
  ...
  it('accept user connection request', () => {
    ...
    NoumManage.verifyNoumReceivedRequest(
      Cypress.env('AUTO_USER_TWO_NAME')
    ).acceptNoumInvite(Cypress.env('AUTO_USER_TWO_NAME'));
