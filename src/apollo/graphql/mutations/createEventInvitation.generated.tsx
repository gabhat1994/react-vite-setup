...
export type CreateEventInvitationMutationVariables = Types.Exact<{
  id: Types.Scalars['ID'];
 ...
 *
 * @example
 * const [createEventInvitationMutation, { data, loading, error }] = useCreateEventInvitationMutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useCreateEventInvitationMutation(baseOptions?: Apollo.MutationHookOptions<CreateEventInvitationMutation, CreateEventInvitationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateEventInvitationMutation, CreateEventInvitationMutationVariables>(CreateEventInvitationDocument, options);
      }
export type CreateEventInvitationMutationHookResult = ReturnType<typeof useCreateEventInvitationMutation>;
export type CreateEventInvitationMutationResult = Apollo.MutationResult<CreateEventInvitationMutation>;
export type CreateEventInvitationMutationOptions = Apollo.BaseMutationOptions<CreateEventInvitationMutation, CreateEventInvitationMutationVariables>;