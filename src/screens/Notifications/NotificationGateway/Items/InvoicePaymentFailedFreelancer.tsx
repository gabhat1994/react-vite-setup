...
const InvoicePaymentFailedFreelancer = ({
  invoice,
  onClick,
  ...basicProps
  ...
  return (
    <AdminMessage
      ...
      body={
        <TranslatedBody
          i18nKey="noumena.notification_type.invoice_payment_failed_freelancer.body"
          values={{
...
export default InvoicePaymentFailedFreelancer;
