...
const InvoiceManualReminderOverdueClient = ({
  invoice,
  onClick,
  ...basicProps
  ...
  <AdminMessage
    {...basicProps}
    data-testid="InvoiceManualReminderOverdueClient"
    body={
      <TranslatedBody
        i18nKey="noumena.notification_type.invoice_manual_reminder_overdue_client.body"
        values={{
...
export default InvoiceManualReminderOverdueClient;
